...
func (r *SessionsAPIRouter) Routes() Routes {
	return Routes{
		Route{
			Name:        "ListAllPlatformSessions",
			Methods:     []string{http.MethodGet},
			Pattern:     "/platform/sessions",
			HandlerFunc: r.sessionController.ListAllSessionsHandler,
		},
		Route{
			Name:        "GetPlatformSessionByID",
			Methods:     []string{http.MethodGet},
			Pattern:     "/platform/sessions/{session_id}",
			HandlerFunc: r.sessionController.GetSessionByIDHandler,
		},
		Route{
			Name:        "GetSession",
			Methods:     []string{http.MethodGet},
